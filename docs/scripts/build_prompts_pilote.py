...
# avec sa nacelle, d'où deux nacelles à l'image). Version 1 : sans la clause « balloon hanging above / no other basket ».
    ...
    ("P02", "2", "Scene: two Directoire onlookers in the foreground leaning toward each other to make a bet, both with their mouths firmly closed in a neutral pause, hands down, behind them the whole rig at rest: the balloon, THE FOLDED PARACHUTE hanging under it like a furled umbrella, and the basket under the parachute, with the crowd around it. Framing: medium close shot at chest height, slightly low angle. Decor: D1. Characters: [PARIEURS], [FOULE] far behind. Props: cane, cockaded hats."),
