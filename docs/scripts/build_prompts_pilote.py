...
# avec sa nacelle, d'où deux nacelles à l'image). Version 1 : sans la clause « balloon hanging above / no other basket ».
    ...
    ("P4a-2", "4a", "Scene: the crowd rocking backwards to follow the balloon with their eyes, hats held on with both hands, the balloon already well above the treetops and rising away, small in the sky. Framing: medium shot on the crowd from behind and slightly to the side. Decor: D1. Characters: [FOULE]. Props: hats, shawls."),
